...
<!-- start banner_x -->
		...
		<div class="gwcxqbj">
		<form action="{{url('shop/dingdanzhongxin')}}"  method="post" class="form center">
			...
			<div class="gwcxd center">
				...
				<div class="content2 center">
					...
					<div class="sub_content fl"><img src="{{ URL::asset('/user/image/gwc_xiaomi6.jpg') }}"></div>
			...
			<div class="jiesuandan mt20 center">
				<div class="tishi fl ml20">
					<ul>
						<li><a href="{{url('shop/liebiao')}}">继续购物</a></li>
						<li>|</li>
