...
<!-- self_info -->
	<div class="grzxbj">
		...
		<div class="rtcont fr">
			...
			<div class="ddxq">
				<div class="ddspt fl"><img src="{{ URL::asset('/user/image/gwc_xiaomi6.jpg') }}" alt=""></div>
			...
			<div class="ddxq">
				<div class="ddspt fl"><img src="{{ URL::asset('/user/image/liebiao_hongmin4_dd.jpg') }}" alt=""></div>
