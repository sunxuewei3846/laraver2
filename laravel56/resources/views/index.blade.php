	...
	<!-- start header -->
		<header>
			<div class="top center">
				...
				<div class="right fr">
					<div class="gouwuche fr"><a href="{{url('shop/gouwuche')}}">购物车</a></div>
					<div class="fr">
						<ul>
							<li><a href="{{url('/')}}" target="_blank">登录</a></li>
							<li>|</li>
...
<!-- start banner_x -->
		<div class="banner_x center">
			...
			<div class="nav fl">
				<ul>
					<li><a href="{{url('shop/liebiao')}}" target="_blank">小米手机</a></li>
					<li><a href="">红米</a></li>
						...
						<div class="pop">
							<div class="left fl">
								<div>
									...
									<div class="xuangou_right fr"><a href="{{url('shop/xiangqing')}}" target="_blank">选购</a></div>
									<div class="clear"></div>
								</div>
								<div>
									<div class="xuangou_left fl">
										<a href="">
											<div class="img fl"><img src="{{ URL::asset('/user/image/5c_80.png') }}" alt=""></div>
								...
								<div>
									<div class="xuangou_left fl">
										<a href="">
											<div class="img fl"><img src="{{ URL::asset('/user/image/xmNOTE2-80.jpg') }}" alt=""></div>
								...
								<div>
									<div class="xuangou_left fl">
										<a href="">
											<div class="img fl"><img src="{{ URL::asset('/user/image/MIX-80.jpg') }}" alt=""></div>
								...
								<div>
									<div class="xuangou_left fl">
										<a href="">
											<div class="img fl"><img src="{{ URL::asset('/user/image/xm5Splus.jpg') }}" alt=""></div>
							...
							<div class="ctn fl">
								...
								<div>
									<div class="xuangou_left fl">
										<a href="">
											<div class="img fl"><img src="{{ URL::asset('/user/image/hmn4x80.png') }}" alt=""></div>
								...
								<div>
									<div class="xuangou_left fl">
										<a href="">
											<div class="img fl"><img src="{{ URL::asset('/user/image/hmnote4-80.jpg') }}" alt=""></div>
								...
								<div>
									<div class="xuangou_left fl">
										<a href="">
											<div class="img fl"><img src="{{ URL::asset('/user/image/hm4x_80.png') }}" alt=""></div>
								...
								<div>
									<div class="xuangou_left fl">
										<a href="">
											<div class="img fl"><img src="{{ URL::asset('/user/image/hm4-80.jpg') }}" alt=""></div>
								...
								<div>
									<div class="xuangou_left fl">
										<a href="">
											<div class="img fl"><img src="{{ URL::asset('/user/image/hm4A-80.jpg') }}" alt=""></div>
							...
							<div class="right fl">
								<div>
									<div class="xuangou_left fl">
										<a href="">
											<div class="img fl"><img src="{{ URL::asset('/user/image/compare.jpg') }}" alt=""></div>
								...
								<div>
									<div class="xuangou_left fl">
										<a href="">
											<div class="img fl"><img src="{{ URL::asset('/user/image/mimobile.jpg') }}" alt=""></div>
		...
		<div class="danpin center">
			...
			<!-- @foreach ($res as $article)
				...
				<div class="mingxing fl">
					<div class="sub_mingxing"><a href=""><img src='{{$article->shop_img}}' alt=""></a></div>
					<div class="pinpai"><a href="">{{$article->shop_name}}</a></div>
					<div class="youhui">{{$article->shop_area}}</div>
					<div class="jiage">{{$article->shop_age}}元起</div>
				</div>
			@endforeach -->

<!-- 			{{ URL::asset('/user/image/pinpai1.png') }}
			{{ URL::asset('/user/image/pinpai2.png') }} -->
				<div class="mingxing fl">
					<div class="sub_mingxing"><a href=""><img src="{{ URL::asset('/user/image/pinpai2.png') }}" alt=""></a></div>
					<div class="pinpai"><a href="">小米5s</a></div>
					<div class="youhui">5月9日-10日，下单立减200元</div>
					<div class="jiage">1999元</div>
				</div>
				<div class="mingxing fl">
					<div class="sub_mingxing"><a href=""><img src="{{ URL::asset('/user/image/pinpai3.png') }}" alt=""></a></div>
					<div class="pinpai"><a href="">小米手机5 64GB</a></div>
					<div class="youhui">5月9日-10日，下单立减100元</div>
					<div class="jiage">1799元</div>
				</div>
				<div class="mingxing fl"> 	
					<div class="sub_mingxing"><a href=""><img src="{{ URL::asset('/user/image/pinpai4.png') }}" alt=""></a></div>
					<div class="pinpai"><a href="">小米电视3s 55英寸</a></div>
					<div class="youhui">5月9日，下单立减200元</div>
					<div class="jiage">3999元</div>
				</div>
				<div class="mingxing fl">
					<div class="sub_mingxing"><a href=""><img src="{{ URL::asset('/user/image/pinpai5.png') }}" alt=""></a></div>
		...
		<div class="peijian w">
			...
			<div class="main center">
				<div class="content">
					...
					<!-- @foreach ($res_pei1 as $article)
					<div class="remen fl">
						<div class="xinpin"><span>新品</span></div>
						<div class="tu"><a href=""><img src='{{$article->shop_img}}'></a></div>
						<div class="miaoshu"><a href="">{{$article->shop_name}}</a></div>
						<div class="jiage">{{$article->shop_age}}元</div>
						<div class="pingjia">{{$article->shop_area}}人评价</div>
						<div class="piao">
							<a href="">
